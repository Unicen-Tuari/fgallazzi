...
{block name=scriptJS}
	...
	<script type="text/javascript" src="js/listado_categorias.js"></script>
...
<div class="container ">
	<div class="page-header">
	  <h1>Listado de Categorías <small> trastos.com</small></h1>
	</div>

	<div class="panel panel-default panel-admin">
	  <div class="panel-body">
	  	<a href="index.php?action=new_categoria&mark=list_all_categorias"><button class="btn btn-default">Nueva Categoría</button></a>
			...
			<td>
				<div class="action-table-admin">
					...
					<i class="glyphicon glyphicon-edit action-edit"
		     		...
		     		<a href="index.php?action=list_all_subcategorias&categoria=id_categoria&mark=list_all_categorias" tag ="href_subcategorias">
		     			<i class="glyphicon glyphicon-zoom-in action-ver"
					data-toggle="tooltip" data-placement="right" title="Ver subcategorías"
		     		onclick = ""></i>	
		     		</a>
